  ...
  <div class="bg-white rounded-xl shadow-lg overflow-hidden">
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 p-6">
      <h1 class="text-2xl font-extrabold text-white text-center flex items-center justify-center">
        <i class="fas fa-box-open mr-3"></i>Nuevo Producto
      </h1>
    </div>

    <form action="ProductoServlet?action=insertar" method="post" class="p-6">
      <div class="space-y-4">
        <div>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input
                    ...
                    min="0"
                    placeholder="0.00"
                    class="w-full pl-8 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
            >
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <select
                    ...
                    name="categoria_id"
                    required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 appearance-none"
            >
      ...
      <div class="mt-8 flex gap-4">
        ...
        <button
                type="submit"
                class="flex-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition duration-300 flex items-center justify-center">
    ...
    <div class="bg-gray-50 px-6 py-4 border-t">
      <div class="flex items-center justify-center gap-2">
        ...
        <p class="text-sm text-gray-600">Los campos marcados son obligatorios</p>
      </div>
    </div>
  </div>
  ...
  <div class="mt-4 bg-white p-4 rounded-lg shadow-md">
    ...
    <ul class="text-xs text-gray-600 space-y-1">
      <li class="flex items-start">
        ...
        <span>Incluye una descripción detallada para mejorar la información del producto</span>
      </li>
      <li class="flex items-start">
        <i class="fas fa-check-circle text-green-500 mr-1 mt-0.5"></i>
        <span>El precio debe incluir dos decimales (ej. 19.99)</span>
      </li>
      <li class="flex items-start">
        <i class="fas fa-check-circle text-green-500 mr-1 mt-0.5"></i>
        <span>Asegúrate de seleccionar la categoría correcta para una mejor organización</span>
      </li>
    </ul>
  </div>
</div>
